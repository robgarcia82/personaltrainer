const CACHE_NAME = 'guia-treino-v114';
const ASSETS = ['./', './index.html', './manifest.json', './icons/icon-192.png', './icons/icon-512.png', './assets/videos/supino-halteres.mp4', './assets/videos/supino-inclinado-halteres.mp4'];
